        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left space-y-3 md:space-y-0">
          <div className="flex items-center space-x-2">
            <Link href="/" className="flex items-center group">
              <JapaGenieLogo className="w-6 h-6 text-genie-gold group-hover:scale-105 transition-transform" />
              <span className="text-sm font-semibold text-genie-gold group-hover:text-yellow-300 transition-colors ml-1.5">
                Japa Genie
              </span>
            </Link>
