            ...
            <div className="bg-white rounded-[1.5rem] overflow-hidden flex flex-col h-[34rem]">
              ...
              <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 bg-gray-50">
                ...
                {msgIndex < currentConv.messages.length - 1 && (
                  <div className="flex justify-start"><div className="bg-white rounded-2xl px-3 py-2 shadow"><div className="flex space-x-1"><div className="w-2 h-2 bg-gray-400 rounded-full animate-bounce" /><div className="w-2 h-2 bg-gray-400 rounded-full animate-bounce [animation-delay:150ms]" /><div className="w-2 h-2 bg-gray-400 rounded-full animate-bounce [animation-delay:300ms]" /></div></div></div>
                )}
              </div>
